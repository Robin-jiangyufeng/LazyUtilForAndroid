package com.robin.lazy.util.photo;
...
public class PhotoUtils {
    ...
    public static void toCamera(Activity activity, File outputFile, int requestCode) {
        if (!isCameraUseAble(activity)) {
            Toast.makeText(activity, R.string.lazy_photo_no_camera, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (resolveInfoList == null || resolveInfoList.isEmpty()) {
            Toast.makeText(activity, R.string.lazy_photo_can_not_use_camera, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public static void toAlbum(Activity activity, int requestCode) {
        try {
            ...
            Toast toast = Toast.makeText(activity, R.string.lazy_photo_can_not_open_album, Toast.LENGTH_SHORT);
